...
After fully installing python xy (install regardless of warnings), re-install cython, numpy, scipy, and tables.
(Re-install whatever modules show up with errors). 
