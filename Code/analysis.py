...
class GridParticles(scaffold.Task):
    ...
    name = "Grid Particles"
    dependencies = [particles.PIVTracking, images.ParseConfig]
    ...
    def run(self):
        ...
        self._loadCellSize()
        tracks = self._import(particles.PIVTracking, "pivtable")
...
class CalculateByTime(scaffold.Task):
    ...
    def run(self):
        ...
        self._tracks = self._import(particles.PIVTracking, "pivtable")
...
RADII = scaffold.registerParameter("radii", np.arange(.5,6,.5))
